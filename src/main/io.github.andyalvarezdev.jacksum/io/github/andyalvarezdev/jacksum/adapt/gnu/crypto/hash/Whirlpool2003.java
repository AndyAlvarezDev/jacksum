package io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.hash;
...
import io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry;
import io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.util.Util;

/**
 * <p>Whirlpool2003, a new 512-bit hashing function operating on messages less than
 ...
 */
   ...
   public boolean selfTest() {
      if (valid == null) {
         valid = new Boolean(
               DIGEST0.equals(Util.toString(new Whirlpool2003().digest())));
      }

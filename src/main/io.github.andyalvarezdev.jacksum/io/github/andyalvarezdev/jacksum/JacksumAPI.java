package io.github.andyalvarezdev.jacksum;
...
import io.github.andyalvarezdev.jacksum.algorithm.Adler32;
import io.github.andyalvarezdev.jacksum.algorithm.Adler32alt;
import io.github.andyalvarezdev.jacksum.algorithm.Cksum;
import io.github.andyalvarezdev.jacksum.algorithm.Crc16;
import io.github.andyalvarezdev.jacksum.algorithm.Crc32;
import io.github.andyalvarezdev.jacksum.algorithm.Crc32Mpeg2;
import io.github.andyalvarezdev.jacksum.algorithm.Crc64;
import io.github.andyalvarezdev.jacksum.algorithm.Crc8;
import io.github.andyalvarezdev.jacksum.algorithm.CrcGeneric;
import io.github.andyalvarezdev.jacksum.algorithm.Edonkey;
import io.github.andyalvarezdev.jacksum.algorithm.Elf;
import io.github.andyalvarezdev.jacksum.algorithm.FCS16;
import io.github.andyalvarezdev.jacksum.algorithm.FCS32;
import io.github.andyalvarezdev.jacksum.algorithm.MD;
import io.github.andyalvarezdev.jacksum.algorithm.MDbouncycastle;
import io.github.andyalvarezdev.jacksum.algorithm.MDgnu;
import io.github.andyalvarezdev.jacksum.algorithm.CombinedChecksum;
import io.github.andyalvarezdev.jacksum.algorithm.MDTree;
import io.github.andyalvarezdev.jacksum.algorithm.None;
import io.github.andyalvarezdev.jacksum.algorithm.Read;
import io.github.andyalvarezdev.jacksum.algorithm.Sum16;
import io.github.andyalvarezdev.jacksum.algorithm.Sum24;
import io.github.andyalvarezdev.jacksum.algorithm.Sum32;
import io.github.andyalvarezdev.jacksum.algorithm.Sum8;
import io.github.andyalvarezdev.jacksum.algorithm.SumBSD;
import io.github.andyalvarezdev.jacksum.algorithm.SumSysV;
import io.github.andyalvarezdev.jacksum.algorithm.Xor8;
import io.github.andyalvarezdev.sugar.util.GeneralProgram;
import io.github.andyalvarezdev.sugar.util.GeneralString;
import io.github.andyalvarezdev.sugar.util.Version;
...
public class JacksumAPI {
    ...
    public static void runCLI(String[] args) {
        io.github.andyalvarezdev.jacksum.cli.Jacksum.main(args);
    }
    ...
    throws NoSuchAlgorithmException {
        ...
        // most popular algorithms first
            ...
            if (alternate) checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.SHA160_HASH); else
            ...
            if (alternate) checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.MD5_HASH); else
            checksum = new MD("MD5");
         ...
         */
            ...
            if (alternate) checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.SHA256_HASH); else
            if (GeneralProgram.isSupportFor("1.4.2"))
                checksum = new MD("SHA-256"); else
                checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.SHA256_HASH);
        } else if (algorithm.equals("sha384") || algorithm.equals("sha-384")) {
            if (alternate) checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.SHA384_HASH); else
            if (GeneralProgram.isSupportFor("1.4.2"))
                checksum = new MD("SHA-384"); else
                checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.SHA384_HASH);
        } else if (algorithm.equals("sha512") || algorithm.equals("sha-512")) {
            if (alternate) checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.SHA512_HASH); else
            if (GeneralProgram.isSupportFor("1.4.2"))
                checksum = new MD("SHA-512"); else
                checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.SHA512_HASH);
        } else if (algorithm.equals("sha224") || algorithm.equals("sha-224")) {
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.SHA224_HASH);
        } else if (algorithm.equals("tiger")  || algorithm.equals("tiger192")  || algorithm.equals("tiger-192")) {
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.TIGER_HASH);
            ...
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.TIGER160_HASH);
        } else if (algorithm.equals("tiger128")  || algorithm.equals("tiger-128")) {
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.TIGER128_HASH);
        } else if (algorithm.equals("tiger2")) {
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.TIGER2_HASH);
            ...
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.RIPEMD160_HASH);
            ...
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.RIPEMD128_HASH);
            ...
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.WHIRLPOOL2000_HASH);
        } else if (algorithm.equals("whirlpool1") || algorithm.equals("whirlpool-1")) {
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.WHIRLPOOL_HASH);
        } else if (algorithm.equals("whirlpool2") || algorithm.equals("whirlpool-2") || algorithm.equals("whirlpool")) {
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.WHIRLPOOL2003_HASH);
            ...
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.MD4_HASH);
        } else if (algorithm.equals("md2") || algorithm.equals("md2sum")) {
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.MD2_HASH);
        } else if (algorithm.equals("sha0") || algorithm.equals("sha-0")) {
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.SHA0_HASH);
            ...
            checksum = new MDgnu(io.github.andyalvarezdev.jacksum.adapt.gnu.crypto.Registry.HAS160_HASH);
        // special algorithms
